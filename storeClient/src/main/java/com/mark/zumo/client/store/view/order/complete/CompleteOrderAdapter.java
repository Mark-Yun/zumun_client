 ...
 */
class CompleteOrderAdapter extends RecyclerView.Adapter<CompleteOrderAdapter.ViewHolder> {
    ...
    CompleteOrderAdapter(final FragmentManager fragmentManager) {
    ...
    @NonNull
    @Override
    public CompleteOrderAdapter.ViewHolder onCreateViewHolder(@NonNull final ViewGroup parent, final int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final CompleteOrderAdapter.ViewHolder holder, final int position) {
        ...
        holder.state.setBackgroundResource(R.drawable.background_order_state_complete);
