...
public class CancelResponse {
    ...
    @SerializedName("tid")
    public final String tId;//	결제 고유 번호. 10자.	String
    @SerializedName("cid")
    public final String cId;//	가맹점 코드. 20자	String
    @SerializedName("status")
    public final String status;//	결제상태값	String
    @SerializedName("partner_order_id")
    public final String partnerOrderId;//	가맹점 주문번호. 최대 100자.	String
    @SerializedName("partner_user_id")
    public final String partnerUserId;//	가맹점 회원 id. 최대 100자.	String
    ...
    public final Amount canceledAmount;//	이번 요청으로 취소된 금액 정보	JSON Object
